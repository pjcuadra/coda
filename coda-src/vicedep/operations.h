...
extern int AllocVnode(Vnode **, Volume *, ViceDataType, ViceFid *, ViceFid *,
                      UserId, int *);
extern int CheckFetchSemantics(ClientEntry *, Vnode **, Vnode **, Volume **,
                               Rights *, Rights *);
extern int CheckGetAttrSemantics(ClientEntry *, Vnode **, Vnode **, Volume **,
                                 Rights *, Rights *);
extern int CheckGetACLSemantics(ClientEntry *, Vnode **, Volume **, Rights *,
                                Rights *, RPC2_BoundedBS *, RPC2_String *);
extern int CheckStoreSemantics(ClientEntry *, Vnode **, Vnode **, Volume **,
                               int, VCP, ViceVersionVector *, FileVersion,
                               Rights *, Rights *);
extern int CheckSetAttrSemantics(ClientEntry *, Vnode **, Vnode **, Volume **,
                                 ...
                                 ViceVersionVector *, FileVersion, Rights *,
                                 Rights *);
extern int CheckSetACLSemantics(ClientEntry *, Vnode **, Volume **, int, VCP,
                                ViceVersionVector *, FileVersion, Rights *,
                                Rights *, RPC2_CountedBS *, AL_AccessList **);
extern int CheckCreateSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                                Volume **, int, VCP, void *, void *, Rights *,
                                Rights *, int = 1);
extern int CheckRemoveSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                                Volume **, int, VCP, void *, void *, Rights *,
                                Rights *, int = 1);
extern int CheckLinkSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                              Volume **, int, VCP, void *, void *, Rights *,
                              Rights *, int = 1);
extern int CheckRenameSemantics(ClientEntry *, Vnode **, Vnode **, Vnode **,
                                char *, Vnode **, char *, Volume **, int, VCP,
                                void *, void *, void *, void *, Rights *,
                                Rights *, Rights *, Rights *, Rights *,
                                Rights *, int = 1, int = 0, dlist * = NULL);
extern int CheckMkdirSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                               Volume **, int, VCP, void *, void *, Rights *,
                               Rights *, int = 1);
extern int CheckRmdirSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                               Volume **, int, VCP, void *, void *, Rights *,
                               Rights *, int = 1);
extern int CheckSymlinkSemantics(ClientEntry *, Vnode **, Vnode **, char *,
                                 Volume **, int, VCP, void *, void *, Rights *,
                                 Rights *, int = 1);
...
extern void PerformGetACL(ClientEntry *, Volume *, Vnode *, RPC2_BoundedBS *,
                          RPC2_String);
extern void PerformStore(ClientEntry *, VolumeId, Volume *, Vnode *, Inode, int,
                         RPC2_Integer, Date_t, ViceStoreId *,
                         RPC2_Integer * = NULL);
extern int StoreBulkTransfer(RPC2_Handle, ClientEntry *, Volume *, Vnode *,
                             Inode, RPC2_Integer);
extern void PerformSetAttr(ClientEntry *, VolumeId, Volume *, Vnode *, int,
                           ...
                           RPC2_Integer * = NULL);
extern void PerformSetACL(ClientEntry *, VolumeId, Volume *, Vnode *, int,
...
extern void PerformRemove(ClientEntry *, VolumeId, Volume *, Vnode *, Vnode *,
                          char *, Date_t, int, ViceStoreId *, DirInode **,
                          int *, RPC2_Integer * = NULL);
...
extern void PerformRename(ClientEntry *, VolumeId, Volume *, Vnode *, Vnode *,
                          Vnode *, Vnode *, char *, char *, Date_t, int,
                          ViceStoreId *, DirInode **, DirInode **, DirInode **,
                          int * = NULL, RPC2_Integer * = NULL);
