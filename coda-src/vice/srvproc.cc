                   ...
                   RPC2_CountedBS *PiggyBS)
{
    ...
    /* Perform operation. */
    {
        ...
        PerformSetACL(client, volptr, v->vptr, StoreId,
                      newACL, NewVS);
                  ...
                  VolumeId *Vidp, RPC2_CountedBS *PiggyBS)
{
    ...
    if (IsReplicatedVolID(Vidp)) {
        eprint("Trying to access %x replicated volume", *Vidp);
        return (EINVAL);
    }
                        ...
                        Rights *rights, Rights *anyrights)
{
    ...
    /* Concurrency-control checks. */
    if (VCmpProc) {
        void *arg1 = (void *)&(*vptr)->disk.dataVersion;
...
int CheckRenameSemantics(ClientEntry *client, Vnode **s_dirvptr,
                         ...
                         VCP VCmpProc, void *s_dirVersion,
                         ...
                         dlist *vlist)
{
    ...
    if (VCmpProc) {
        ...
        /* Source directory. */
        {
            arg1 = (void *)&(*s_dirvptr)->disk.dataVersion;
        ...
        /* Target directory. */
        {
            arg1 = (void *)&(*t_dirvptr)->disk.dataVersion;
        ...
        /* Source object. */
        {
            arg1 = (void *)&(*s_vptr)->disk.dataVersion;
        ...
        /* Target object. */
        if (TargetExists) {
            arg1 = (void *)&(*t_vptr)->disk.dataVersion;
...
{
    return (Check_CLMS_Semantics(
        client, dirvptr, vptr, Name, volptr, CLMS_MakeDir,
        VCmpProc, dirVersion, Version, rights, anyrights, MakeProtChecks));
}
...
{
    return (Check_CLMS_Semantics(
        client, dirvptr, vptr, Name, volptr, CLMS_SymLink,
        VCmpProc, dirVersion, Version, rights, anyrights, MakeProtChecks));
}
                                ...
                                Rights *anyrights, int MakeProtChecks)
{
    ...
    /* Concurrency-control checks. */
    if (VCmpProc) {
        void *arg1 = (void *)&(*dirvptr)->disk.dataVersion;
        ...
        if (vptr) {
            arg1 = (void *)&(*vptr)->disk.dataVersion;
                              ...
                              Rights *anyrights, int MakeProtChecks)
{
    ...
    if (VCmpProc) {
        ...
        arg1 = (void *)&(*dirvptr)->disk.dataVersion;
        if ((errorCode = VCmpProc((*dirvptr)->disk.type, arg1,
                                  dirVersion))) {
            SLog(0, "%s: %s, VCP error (%d)", ProcName, FID_(&Did), errorCode);
            return (errorCode);
