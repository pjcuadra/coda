...
int main(int argc, char *argv[])
{
    ...
    printf("\tReplica0 id %08x, Server0 %s\n", volinfo.RepVolMap.Volume0,
           viceaddr(volinfo.Server0));
    printf("\tReplica1 id %08x, Server1 %s\n", volinfo.RepVolMap.Volume1,
           viceaddr(volinfo.Server1));
    printf("\tReplica2 id %08x, Server2 %s\n", volinfo.RepVolMap.Volume2,
           viceaddr(volinfo.Server2));
    printf("\tReplica3 id %08x, Server3 %s\n", volinfo.RepVolMap.Volume3,
           viceaddr(volinfo.Server3));
    printf("\tReplica4 id %08x, Server4 %s\n", volinfo.RepVolMap.Volume4,
           viceaddr(volinfo.Server4));
    printf("\tReplica5 id %08x, Server5 %s\n", volinfo.RepVolMap.Volume5,
           viceaddr(volinfo.Server5));
    printf("\tReplica6 id %08x, Server6 %s\n", volinfo.RepVolMap.Volume6,
           viceaddr(volinfo.Server6));
    printf("\tReplica7 id %08x, Server7 %s\n", volinfo.RepVolMap.Volume7,
           viceaddr(volinfo.Server7));
    printf("\n");
    printf("\tVSGAddr %x\n", volinfo.VSGAddr);
    printf("\n");
